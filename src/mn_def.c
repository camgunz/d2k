...
default_t defaults[] = {
  ...
  {"max_player_corpse", {&corpse_queue_size}, {32}, -1, UL, // killough 2/8/98
...
//#endif
  ...
  {"snd_channels", {&default_numChannels}, {MAX_SOUND_CHANNELS}, 1, MAX_SOUND_CHANNELS,
...
// CPhipps - now they're the doom codes, so default.cfg can be portable
  ...
  KEYBIND("key_chatplayer1", destination_key_green, 'g'),
  // killough 11/98: fix 'i'/'b' reversal
  KEYBIND("key_chatplayer2", destination_key_indigo, 'i'),
  KEYBIND("key_chatplayer3", destination_key_brown, 'b'),
  KEYBIND("key_chatplayer4", destination_key_red, 'r'),
